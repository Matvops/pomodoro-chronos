        ...
        <Container>
          <GenericHtml>
            ...
            <p>
              ...
              <RouterLink path='/settings'>página de configurações</RouterLink> e ajustar os minutos
              como preferir.
            </p>
            ...
            <p>Todas as suas tarefas e ciclos concluídos ficam salvos no{' '}
              <RouterLink path='/history'>histórico</RouterLink>, com status de completas ou
            ...
            <p>
              ...
              <RouterLink path='/'>voltar para a página inicial</RouterLink> e iniciar seus
              Pomodoros! 🍅🚀
            </p>
