  ...
  return (
    <>
      <MainTemplate>
        <Container>
          <GenericHtml>
            <Heading>Página não encotrada</Heading>
            <p>
            ...
            <p>
              ...
              segurança para a <RouterLink path='/'>página principal</RouterLink> ou{' '}
              <RouterLink path='/history'>para o histórico</RouterLink> — ou pode ficar por aqui e
